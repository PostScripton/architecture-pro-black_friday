...
В этой проектной работе вас ждёт кейс онлайн-магазина «Мобильный мир», где можно купить аксессуары для смартфонов. Уже готов Proof of Concept (PoC) для сайта, чей бэкенд состоит из нескольких микросервисов.
...
<img alt="Схема взаимодействия pymongo-api с MongoDB" src="/img/pymongo-api-mongodb-architecture.png" />
